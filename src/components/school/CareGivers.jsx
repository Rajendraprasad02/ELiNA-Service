  ...
  return (
    <>
      <div className="flex text-center flex-col justify-center items-center py-28 gap-10 HeroBg2">
        ...
        <a href="/#/school-form">
          <button className="animationHero bg-blue-600 border-blue-600 lg:text-2xl text-white hover:bg-transparent hover:border-blue-600 hover:text-blue-600 py-2 px-4 rounded-full">
