  ...
  return (
    <>
      <div className="HeroBg">
        <h1 className=" text-center  text-5xl lg:text-6xl font-black text-indigo-600  p-5 lg:pt-[5%]">
          Together For A Purpose
        </h1>
        {OurVisionContent.map((item) => (
          <div className="">
            {item.leftImg && innerWidth > 430 ? (
              <div class=" flex flex-col  justify-between lg:flex-row md:flex-col-reverse md:p-10 lg:w-[100%] lg:h-[30%]  ">
                ...
                <div class=" flex flex-col justify-around lg:p-4 leading-normal lg:w-[50%] md:w-full lg:pr-[5%] ">
              ...
              <div class=" flex flex-col items-center justify-around lg:flex-row p-0 md:p-10 lg:w-[100%] lg:h-[30%] ">
                <div class=" flex flex-col justify-between p-4 leading-normal lg:w-[50%] md:w-full lg:pl-[5%]">
                  <h1 class="mb-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
                    {item.h1}
                  </h1>
                  <p class="mb-3 text-lg font-normal text-gray-700 dark:text-gray-400">
